...
let i = 0
    setInterval(() => {
      bot.user.setActivity(statuses[i], {type : 'PLAYING'})//À la place de PLAYING tu peux mettre WATCHING, COMPETING, LISTENING, STREAMING.
        i = ++i % statuses.length
    },  1e4);
...
// A MODIFIER
const botId = "Enter the bot id" 
const botusername = "Name Bot"
